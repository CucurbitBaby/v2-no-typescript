...
export default {
  ...
  children: [
    ...
    {
      path: 'vue2/demo-08',
      name: 'test-demo-vue2-demo-08',
      component: () => import('@/views/test-demo/vue2/demo-08/index.vue')
    },
    {
      path: 'vue2/demo-09',
    ...
    {
      path: 'vue2/demo-11',
      name: 'test-demo-vue2-demo-11',
      component: () => import('@/views/test-demo/vue2/demo-11/index.vue')
    }
  ]
}
